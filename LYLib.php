...
class LYLib
{
    ...
    public static function parseDoc($file, $dir)
    {
        ...
        $cmd = sprintf("env https_proxy= curl --output %s --request POST --url 'https://unoserver.api.openfun.dev/request' --compressed -H %s --header 'Content-Type: multipart/form-data' --form %s --form 'convert-to=html'",
